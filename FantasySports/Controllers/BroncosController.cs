...
{
    public class BroncosController : Controller
    {
        private readonly FantasySportsContext _context;
        public BroncosController(FantasySportsContext context)
        {
            _context = context;
        }
        public IActionResult Index()
        {
            BroncosViewModel model = new BroncosViewModel(_context);
            return View(model);
        }
        [HttpPost]
        ...
        {
            BroncosViewModel model = new BroncosViewModel(_context);
            Broncos football = new(teamId, week1Score, week2Score, week3Score, week4Score, week5Score, week6Score, week7Score, week8Score, week9Score, week10Score, week11Score, week12Score, week13Score, week14Score, week15Score, week16Score, week17Score, week18Score);
