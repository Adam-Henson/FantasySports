...
namespace FantasySports.Controllers
{
    public class EaglesController : Controller
    {
        ...
        public EaglesController(FantasySportsContext context)
        {
            _context = context;
        }
        public IActionResult Index()
        {
            EaglesViewModel model = new EaglesViewModel(_context);
            return View(model);
        }
        [HttpPost]
        ...
        {
            EaglesViewModel model = new EaglesViewModel(_context);
            Eagles football = new(teamId, week1Score, week2Score, week3Score, week4Score, week5Score, week6Score, week7Score, week8Score, week9Score, week10Score, week11Score, week12Score, week13Score, week14Score, week15Score, week16Score, week17Score, week18Score);
