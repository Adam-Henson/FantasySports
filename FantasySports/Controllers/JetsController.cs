...
namespace FantasySports.Controllers
{
    public class JetsController : Controller
    {
        ...
        public JetsController(FantasySportsContext context)
        {
            _context = context;
        }
        public IActionResult Index()
        {
            JetsViewModel model = new JetsViewModel(_context);
            return View(model);
        }
        [HttpPost]
        ...
        {
            JetsViewModel model = new JetsViewModel(_context);
            Jets football = new(teamId, week1Score, week2Score, week3Score, week4Score, week5Score, week6Score, week7Score, week8Score, week9Score, week10Score, week11Score, week12Score, week13Score, week14Score, week15Score, week16Score, week17Score, week18Score);
