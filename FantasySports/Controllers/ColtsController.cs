...
{
    public class ColtsController : Controller
    {
        private readonly FantasySportsContext _context;
        public ColtsController(FantasySportsContext context)
        {
            _context = context;
        }
        public IActionResult Index()
        {
            ColtsViewModel model = new ColtsViewModel(_context);
            return View(model);
        }
        [HttpPost]
        ...
        {
            ColtsViewModel model = new ColtsViewModel(_context);
            Colts football = new(teamId, week1Score, week2Score, week3Score, week4Score, week5Score, week6Score, week7Score, week8Score, week9Score, week10Score, week11Score, week12Score, week13Score, week14Score, week15Score, week16Score, week17Score, week18Score);
