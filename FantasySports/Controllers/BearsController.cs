...
namespace FantasySports.Controllers
{
    public class BearsController : Controller
    {
        ...
        public BearsController(FantasySportsContext context)
        {
            _context = context;
        }
        public IActionResult Index()
        {
            BearsViewModel model = new BearsViewModel(_context);
            return View(model);
        }
        [HttpPost]
        ...
        {
            BearsViewModel model = new BearsViewModel(_context);
            Bears football = new(teamId, week1Score, week2Score, week3Score, week4Score, week5Score, week6Score, week7Score, week8Score, week9Score, week10Score, week11Score, week12Score, week13Score, week14Score, week15Score, week16Score, week17Score, week18Score);
