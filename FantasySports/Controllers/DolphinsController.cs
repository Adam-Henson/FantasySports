...
{
    public class DolphinsController : Controller
    {
        private readonly FantasySportsContext _context;
        public DolphinsController(FantasySportsContext context)
        {
            _context = context;
        }
        public IActionResult Index()
        {
            DolphinsViewModel model = new DolphinsViewModel(_context);
            return View(model);
        }
        [HttpPost]
        ...
        {
            DolphinsViewModel model = new DolphinsViewModel(_context);
            Dolphins football = new(teamId, week1Score, week2Score, week3Score, week4Score, week5Score, week6Score, week7Score, week8Score, week9Score, week10Score, week11Score, week12Score, week13Score, week14Score, week15Score, week16Score, week17Score, week18Score);
